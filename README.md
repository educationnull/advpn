ADVPN is once again maintained
============
...
This scripts primary mission in life is to allow a user to have a home VPN for as cost effective as possible and without being a technical wizard.  Hence the design of advpn to work on a Raspberry Pi ($35) and then one command installer.  Followed by easy management of the VPN thereafter with the 'advpn' command.  That being said...
...
After the installation is complete you can use the command 'advpn' to manage the server.
...
then you can use the 'advpn add nopass' option to generate that.
...
is still valid or has been revoked.  Great way to keep track of what you did with 'advpn add' and 'advpn revoke'.

You can run just 'advpn' to see all the options.
...
[[DISCONTINUED APRIL 17]] You can also post on the [Google Space](https://goo.gl/spaces/kgp2Mcy5RDfZ5SSf8) I created for ADVPN, especially suited for general questions or discussions.

You can also join #advpn <ircs://freenode/advpn> on freenode in IRC for community support or general questions.
...
[InnovativeInventor/docker-advpn](https://github.com/InnovativeInventor/docker-advpn)
A secure docker container that sets up ADVPN and SSH.
...
If you contribute often I can add you as a member of the ADVPN project.
